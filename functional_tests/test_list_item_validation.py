...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        self.browser.find_element_by_id('id_item_text').send_keys("\n")
        ...
        self.browser.find_element_by_id('id_item_text').send_keys("Buy milk\n")
        ...
        self.browser.find_element_by_id('id_item_text').send_keys("Make tea\n")
        self.check_for_row_in_list_table("1: Buy milk")
